...
const Footer = () => {
  return (
    <footer className="bg-[#104016] text-white py-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start">
          ...
          <div className="mb-8 md:mb-0 text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              <a href="#" className="hover:text-[#ffd2a8] transition-colors">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:nke.infinity@gmail.com" className="hover:text-[#ffd2a8] transition-colors">
                  nke.infinity@gmail.com
                </a>
              </li>
              <li className="flex items-center">
                <FaMapMarkerAlt className="mr-3 text-[#ffd2a8]" />
                <span>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-semibold mb-4 border-b border-[#ffd2a8] pb-2">Quick Links</h4>
            <ul className="space-y-3">
              <li>
                <a href="/" className="hover:text-[#ffd2a8] transition-colors">Home</a>
              </li>
              <li>
                <a href="/products" className="hover:text-[#ffd2a8] transition-colors">Products</a>
              </li>
              <li>
                <a href="/about" className="hover:text-[#ffd2a8] transition-colors">About Us</a>
              </li>
              <li>
